...
function (_PureComponent) {
  _inherits(LinkDialog, _PureComponent);
  ...
  function LinkDialog(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(LinkDialog).call(this, props));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "preprocess", function (e) {
      ...
      if (!altText) {
        _message2.default.error('Chưa nhập đoạn text hiển thị');

        return;
      }

      if (!url) {
        _message2.default.error('Chưa nhập link');
